...
function Contact() {
    ...
    return (
        <Box mt={"50px"} height={"100vh"} >
            ...
            <Flex width={"90%"} margin={"50px auto 20px auto"}  flexDir={{base:"coloumn", sm:"column",md:"row",lg:"row"}} justifyContent={"center"} gap="20px" align={"center"}>
                <Box
                 fontSize="20px"
                  width="285px"
                   borderRadius={"20px"}
...
<Box className="contact section" id="contact">
    ...
    <Box className="contact_container container grid">
        <Box>
            <Text className="contact_message">I am currently specializing in MERN development.<br />
                Feel free to drop a message for any suggestion,<br />and we can get in touch.</Text>
            <Box className="contact_information">
                <i className="uil uil-phone-alt contact_icon"></i>

                <Box>
                    <Heading className="contact_title">Call Me</Heading>
                    <Text className="contact_subtitle" id="contact-phone">+91 6396765981</Text>
                </Box>
            </Box>

            <Box className="contact_information">
                <Link href="mailto:shubhangisaini205@gmail.com"> <Link className="uil uil-envelope-alt contact_icon"></Link></Link>

                <Box>
                    <Heading className="contact_title">Email</Heading>
                    <Link href="mailto:shubhangisaini205@gmail.com"><Text className="contact_subtitle" id="contact-email">shubhangisaini205@gmail.com</Text> </Link>
                </Box>
            </Box>

            <Box className="contact_information">
                <Link className="uil uil-map-marker contact_icon"></Link>

                <Box>
                    <Heading className="contact_title">Location</Heading>
                    <Text className="contact_subtitle">Saharanpur , Uttar Pradesh</Text>
                </Box>
            </Box>
        </Box>
